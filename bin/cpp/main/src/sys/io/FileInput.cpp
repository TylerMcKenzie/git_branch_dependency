...
HX_LOCAL_STACK_FRAME(_hx_pos_b846ebd5a0a404e5_47_readBytes,"sys.io.FileInput","readBytes",0xfebe1f4e,"sys.io.FileInput.readBytes","/usr/share/haxe/std/cpp/_std/sys/io/FileInput.hx",47,0x4095cd33)
namespace sys{
namespace io{
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_GC_STACKFRAME(&_hx_pos_b846ebd5a0a404e5_47_readBytes)
HXDLIN(  47)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
